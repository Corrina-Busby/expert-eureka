...
async function dropdownForm() {
    try {
        ...
        await select1.click();
        await (await (await driver).findElement(By.xpath("//nb-option[@value='1']"))).click();
        await (await (await driver).findElement(By.xpath("//nb-option[@value='2']"))).click();
        await (await (await driver).findElement(By.xpath("//nb-option[@value='3']"))).click();
        await select1.click();
        await (await (await driver).findElement(By.xpath(`//select[@formcontrolname='select2']/option[@value="0: 'volvo'"]`))).click();
        await (await (await driver).findElement(By.xpath(`//select[@formcontrolname='select2']/option[@value="2: 'opel'"]`))).click();
